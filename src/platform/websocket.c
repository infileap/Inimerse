...
int im_ws_send_pong(ImSocket *s,const void *data,size_t n){if(!s||n>=126)return -1;unsigned char h[2]={0x8a,(unsigned char)n};return send_all(s,h,2)||send_all(s,data,n);}
