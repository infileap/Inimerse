...
const tests = ['upp_reference.test.js', 'upp_session.test.js', 'crp_reference.test.js', 'crp_relay.test.js', 'crp_client.test.js', 'vverse_validate.test.js', 'vverse_pack.test.js', 'say_reference.test.js'];
